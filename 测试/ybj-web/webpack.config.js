...
// sass文件的处理
	...
	plugins: [
		...
		new HtmlWebpackPlugin({
            filename:'pages/insure/insureApply/insureApply.html', //生产的html文件名
            template:'./src/pages/insure/insureApply/insureApply.html'  
		}),
		new HtmlWebpackPlugin({
            filename:'pages/claim/claimSuccess/claimSuccess.html', //生产的html文件名
            template:'./src/pages/claim/claimSuccess/claimSuccess.html'  
		}),
		new HtmlWebpackPlugin({
            filename:'pages/claim/claimApply/claimApply.html', //生产的html文件名
            template:'./src/pages/claim/claimApply/claimApply.html'  
		}),
